...
Отиваме на изток от входа и се озоваваме в коридор. Връщаме се на запад и изведнъж сме в някаква магическа лаборатория. That's just how magic dungeons roll, go with it. Когато казваме "`.set_link` добавя връзки в двете посоки", просто си го направете, пък ако по-нататъшни извиквания променят нещо, няма проблеми.
...
Всякакви грешки, които могат да случат при извикване на `set_link` се очаква да се върнат от тази функция ако се случат.
